...
async function open_sharer() {
    ...
    sharer_html.add(
        sharer_html.div(
            ...
            sharer_html.div({ id: "sharer-window" }, [
                sharer_html.div({ id: "header-icon-container" }, [
                    sharer_html.div(
                        { id: "temp-header-icon" },
    ...
    document.body.innerHTML = sharer_html.get_html();
}

open_sharer().then(() => {
    document.getElementById("header-icon-container").onclick = () => {
        document.getElementById("temp-header-icon").classList.toggle("show");
    };
});
